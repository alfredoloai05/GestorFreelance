...
const dueLabel = (dueDate) => {
  ...
  return new Intl.DateTimeFormat('es-EC', { day: '2-digit', month: 'short' }).format(new Date(`${dueDate}T12:00:00`));
};
...
export default function App() {
  ...
  const backup=()=>{const blob=new Blob([JSON.stringify(data,null,2)],{type:'application/json'});const url=URL.createObjectURL(blob);const a=document.createElement('a');a.href=url;a.download=`vencodex-workspace-${localDayKey()}.json`;a.click();URL.revokeObjectURL(url);};
